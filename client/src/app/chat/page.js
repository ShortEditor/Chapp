        ...
        <div className="p-4 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative shrink-0">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center font-bold text-sm text-cyan-300 border border-white/10 overflow-hidden uppercase" style={{ fontFamily: 'var(--font-jakarta)' }}>
              ...
              <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-[#09090c] ${isConnected ? 'status-online' : 'bg-amber-400'}`}></div>
            </div>
            <div className="min-w-0">
              <h2 className="text-sm font-bold text-slate-100 truncate" style={{ fontFamily: 'var(--font-jakarta)' }}>
                {currentUser?.username}
              </h2>
              <p className="text-[10px] truncate leading-tight" style={{ color: 'var(--foreground-muted)' }}>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-2.5 rounded-xl hover:bg-white/6 text-slate-400 hover:text-cyan-400 transition-all duration-200"
              title="Settings"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl hover:bg-white/6 text-slate-400 hover:text-red-400 transition-all duration-200"
              title="Sign out"
            >
        ...
        <div className="px-3 pt-3 pb-1">
          <div className="flex gap-1 bg-white/3 rounded-2xl p-1 border border-white/5">
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all duration-200 ${activeTab === 'chats' ? 'bg-white/8 text-slate-100 shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
              style={activeTab === 'chats' ? { fontFamily: 'var(--font-jakarta)' } : {}}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all duration-200 ${activeTab === 'friends' ? 'bg-white/8 text-slate-100 shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
              style={activeTab === 'friends' ? { fontFamily: 'var(--font-jakarta)' } : {}}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all duration-200 relative ${activeTab === 'requests' ? 'bg-white/8 text-slate-100 shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
              style={activeTab === 'requests' ? { fontFamily: 'var(--font-jakarta)' } : {}}
            >
              <BellRing className="w-3.5 h-3.5" />
              Requests
              {pendingRequests.length > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-cyan-500 text-[#09090c] font-black text-[9px] rounded-full flex items-center justify-center">
      ...
      <div className={`flex-1 h-full flex flex-col bg-[#08080a]/30 backdrop-blur-3xl relative z-10 ${!activeFriend ? 'hidden md:flex' : 'flex'}`}>
        ...
        {activeFriend ? (
            ...
            <div className="h-16 border-b border-white/5 px-4 md:px-6 flex items-center justify-between select-none bg-black/10 z-10 shrink-0">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="md:hidden p-2 -ml-1 rounded-xl hover:bg-white/6 text-slate-400 hover:text-slate-200 transition-all duration-200 mr-1"
                >
                  <ArrowLeft className="w-4 h-4" />
                </button>
                <div className="relative shrink-0">
                  <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center font-bold text-sm border border-white/10 uppercase text-slate-200 overflow-hidden" style={{ fontFamily: 'var(--font-jakarta)' }}>
                  ...
                  {onlineFriends.get(activeFriend.id) === 'online' && (
                    <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-[#09090c] status-online"></div>
                  )}
                </div>
                <div>
                  <h3 className="text-sm font-bold text-slate-100" style={{ fontFamily: 'var(--font-jakarta)' }}>{activeFriend.username}</h3>
                  <p className="text-[10px] flex items-center gap-1.5 leading-tight" style={{ color: 'var(--foreground-muted)' }}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8 select-none relative overflow-hidden">
            <div className="orb orb-purple opacity-8"></div>
            
            <div className="w-24 h-24 rounded-[28px] bg-gradient-to-br from-cyan-400 to-indigo-600 flex items-center justify-center shadow-2xl shadow-cyan-500/25 ring-1 ring-white/10 mb-6 relative">
              <Sparkles className="w-12 h-12 text-white" />
            </div>
            
            <h2 className="text-3xl gradient-text mb-2" style={{ fontFamily: 'var(--font-jakarta)' }}>Chapp</h2>
            <p className="text-sm max-w-[280px] leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
              Pick a friend from the sidebar to start a private conversation.
            </p>

            <div className="mt-8 grid grid-cols-1 gap-3 max-w-[360px] w-full">
              <div className="flex gap-3 items-start p-4 rounded-2xl glass-card border border-white/5 text-left">
                <div className="p-2 rounded-xl bg-cyan-500/10 text-cyan-400 shrink-0 mt-0.5">
                  <Lock className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs font-semibold text-slate-200 mb-0.5" style={{ fontFamily: 'var(--font-jakarta)' }}>End-to-end private</h4>
                  <p className="text-[10px] leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
                    Messages are stored locally on your device and deleted from our server after delivery.
                  </p>
                </div>
              </div>
              <div className="flex gap-3 items-start p-4 rounded-2xl glass-card border border-white/5 text-left">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-slate-200 mb-0.5" style={{ fontFamily: 'var(--font-jakarta)' }}>Cloud backup</h4>
                  <p className="text-[10px] leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
                    Use Settings → Backup to encrypt and save your chats securely in the cloud.
                  </p>
                </div>
              </div>
            </div>
